...
#include <memory>
#include "../AmoebotSim/ui/glitem.h"
...
void GLItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GLItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GLItem::beforeRendering)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GLItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GLItem::afterRendering)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GLItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickItem::staticMetaObject>(),
    qt_meta_stringdata_GLItem.data,
    qt_meta_data_GLItem,
    qt_static_metacall,
    nullptr,
    nullptr
